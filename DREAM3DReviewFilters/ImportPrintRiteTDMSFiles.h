...
private:
  ...
  float m_LaserOnThreshold = {};
  int m_LaserOnArrayOption = {};
  QString m_OutputDirectory = {};
  QString m_OutputFilePrefix = {};
  int m_SpatialTransformOption = {};
  bool m_DowncastRawData = {};
  bool m_ScaleLaserPower = {};
  FloatVec2Type m_PowerScalingCoefficients = {};
  bool m_ScalePyrometerTemperature = {};
  FloatVec2Type m_TemperatureScalingCoefficients = {};
  bool m_SplitRegions1 = {};
  bool m_SplitRegions2 = {};
  int m_LayerForScaling = {};
  QString m_InputSpatialTransformFilePath = {};
  float m_SearchRadius = {};

  int32_t m_NumParts;
  int32_t m_NumLayers;
  int32_t m_NumLayersToImport;
  int32_t m_Offset;
